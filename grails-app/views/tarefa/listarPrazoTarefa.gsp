...
<div id="list-tarefa" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="diasAtraso" title="${message(code: 'tarefa.prazo.label', default: 'Dias Em Atraso')}" />

            <g:sortableColumn property="diasFalta" title="${message(code: 'tarefa.titulo.label', default: 'Dias Em Falta')}" />
        </tr>
        </thead>
        <tbody>
